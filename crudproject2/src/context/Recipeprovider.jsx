...
const Recipeprovider = (props) => {
  ...
  // ✅ Function to restore default recipes
  const restoreDefaultRecipes = () => {
    localStorage.setItem("recipes", JSON.stringify(defaultdata));
    localStorage.setItem("isInitialized", "true");
    setdata(defaultdata);
    console.log("✅ Recipes restored to default.");
  };
  ...
  useEffect(() => {
    ...
    // ✅ Expose restore function to browser console
    window.restoreRecipes = restoreDefaultRecipes;
  }, []);

  return (
    <recipecontext.Provider value={[data, setdata, restoreDefaultRecipes]}>
      {props.children}
