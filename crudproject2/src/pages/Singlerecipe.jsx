...
<div className='flex lg:flex-row flex-col w-full min-h-full gap-3 lg:items-start overflow-x-hidden px-3'>
      ...
      <div className="lg:w-[50%] left flex flex-col  w-[100%] gap-y-3 px-5 py-5 bg-slate-900   rounded ">
       ...
       <form onSubmit={handleSubmit(submithandler)} className='lg:w-[50%] w-[100%] min-h-full  flex flex-col  items-center  gap-4 p-4 bg-[#0F172B] shadow-md rounded-md text-white  mb-5'>
