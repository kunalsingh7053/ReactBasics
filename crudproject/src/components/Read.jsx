...
const Read = (props) => {
 ...
 return <li className=" mb-2 flex justify-between items-center p-1 rounded bg-gray-800" key={todo.id}> <span className="text-[10px] lg:text-[15px] font-thin block break-words whitespace-normal w-[80%] text-white">
      {todo.title}
    </span>
